...
<div class="max-w-7xl mx-auto">
    ...
    <form method="POST" action="{{ route('bulk-action') }}" class="mb-6" id="bulk-form">
        ...
        <x-bulk-actions type="tasks" colspan="9" :statuses="['pending', 'in_progress', 'completed', 'cancelled']" />
    </form>
    ...
    <div class="bg-white dark:bg-black rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-x-auto w-full">
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                ...
                @empty
                    <tr><x-empty-state :colspan="9" icon="clipboard" title="No tasks found." message="Create tasks to track your work." /></tr>
                @endforelse
            </tbody>
        </table>
    </div>
