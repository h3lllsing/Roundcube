                    ...
                    @forelse ($gMails as $gMail)
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                            ...
                            <td class="px-6 py-3 whitespace-nowrap">
                                @php $_canEdit = auth()->user()->hasRole('super-admin') || ($gMail->module && auth()->user()->canOnModule($gMail->module, 'update')); @endphp
                                @php $_canDelete = auth()->user()->hasRole('super-admin') || ($gMail->module && auth()->user()->canOnModule($gMail->module, 'delete')); @endphp
