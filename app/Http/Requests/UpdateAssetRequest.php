...
class UpdateAssetRequest extends FormRequest
{
    ...
    {
        $assetId = $this->route('id') ?? $this->route('asset');
        return [
            'updated_at' => 'required|date',
            'asset_tag' => ['nullable', 'string', 'max:100', Rule::unique('assets', 'asset_tag')->ignore($assetId)],
            ...
            'qr_identifier' => ['nullable', 'string', 'max:100', Rule::unique('assets', 'qr_identifier')->ignore($assetId)],
