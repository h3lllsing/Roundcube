...
class HostingService
{
     ...
     * @return \Illuminate\Pagination\LengthAwarePaginator<int, Hosting>
     */
    public function list(array $filters = []): \Illuminate\Pagination\LengthAwarePaginator
    {
        ...
        $sortBy = in_array($filters['sort_by'] ?? 'expiry_date', ['name','provider','plan','domain','expiry_date','cost','status','created_at']) ? ($filters['sort_by'] ?? 'expiry_date') : 'expiry_date';
    ...
    public function delete(Hosting $entry): void { $entry->delete(); }
}
