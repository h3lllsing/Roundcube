...
{
    /** @use HasFactory<\Database\Factories\OtherServiceFactory> */
    use HasFactory, SoftDeletes, LogsActivity, HasAttachments;

    protected $table = 'other_services';

    protected $fillable = ['user_id', 'module_id', 'name', 'service_type', 'provider', 'website', 'cost', 'start_date', 'expiry_date', 'status', 'notes'];
