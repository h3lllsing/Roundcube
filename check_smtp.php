...
$accounts = App\Models\EmailAccount::where('status', \App\Enums\AccountStatus::Active)->select('id','email','smtp_host','smtp_port','smtp_encryption','smtp_username','sync_enabled')->get();
