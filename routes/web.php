...
Route::middleware(['auth', 'suspended'])->group(function () {
    ...
    Route::patch('/vault/{id}/restore', [VaultController::class, 'restore'])->name('vault.restore');
    Route::delete('/vault/{id}/force-delete', [VaultController::class, 'forceDelete'])->name('vault.force-delete');
    Route::post('/vault/{id}/reveal', [VaultController::class, 'reveal'])->name('vault.reveal')->middleware('throttle:10,1');
