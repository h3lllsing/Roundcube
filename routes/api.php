...
Route::middleware(["auth:sanctum", "throttle:api", "log.api"])->group(function () {
    ...
    Route::post("vault/{vault}/reveal", [VaultController::class, "reveal"]);
    ...
    // VPS
    Route::get("vps", [VpsController::class, "index"])->name('api.vps.index');
    Route::post("vps", [VpsController::class, "store"])->name('api.vps.store');
    Route::get("vps/{vps}", [VpsController::class, "show"])->name('api.vps.show');
    Route::put("vps/{vps}", [VpsController::class, "update"])->name('api.vps.update');
    Route::delete("vps/{vps}", [VpsController::class, "destroy"])->name('api.vps.destroy');
...
// Super-admin only
Route::middleware(["auth:sanctum", "throttle:api", "log.api", "role:super-admin"])->group(function () {
    // Features (CRUD)
